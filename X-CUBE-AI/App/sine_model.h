...
#define AI_SINE_MODEL_ORIGIN_MODEL_NAME   "sine_wave"

/******************************************************************************/
#define AI_SINE_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SINE_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SINE_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)
...
#define AI_SINE_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
...
#define AI_SINE_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SINE_MODEL_OUT_1_CHANNEL     (1)
#define AI_SINE_MODEL_OUT_1_SIZE        (1)
#define AI_SINE_MODEL_OUT_1_SIZE_BYTES  (4)
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sine_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sine_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
